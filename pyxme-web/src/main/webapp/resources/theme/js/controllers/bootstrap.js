...
app.controller('TypeaheadDemoCtrl', ['SessionData', '$cookies', '$scope', '$http', '$state', function(SessionData, $cookies, $scope, $http, $state) {
	...
	$scope.logout = function(){
       SessionData.updateSession(null, true);
        ...
        var response = $http.post('logoutSubsidiary_json.json', obj);
