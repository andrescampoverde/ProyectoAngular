...
app.controller('PersonController', ['ngNotify','restPersonService','system_variable', '$scope', '$timeout', '$http', 'Alertify', 'blockUI', 'ngTableParams', '$modal', "genericService",
                           function (ngNotify,restPersonService , system_variable,   $scope, $timeout, $http, Alertify, blockUI, ngTableParams, $modal, genericService) {
        controller = this;
        ...
        controller.tableParams = new ngTableParams({
            ...
            getData: function ($defer, params) {
                ...
                var response = $http.post('retrievePerson_json.json', paramFilter);
        ...
        controller.cargarVariables = function () {
            ...
            if (system_variable.getInvoiceVariable() == undefined) {
                ...
                repuesta.then(function (data) {
                	...
                	Alertify.error('Ocurrio un error al cargar las variables!');
                });
            } else {
